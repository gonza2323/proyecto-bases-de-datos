...
-- 5 ordenes por restaurante, para tener suficientes reseñas
      ...
      (1000, 1000, 1000, 'DELIVERED', 15000),
      (1001, 1000, 1000, 'DELIVERED', 10000),
      (1002, 1000, 1000, 'DELIVERED', 17000),
      (1003, 1000, 1000, 'DELIVERED', 18000),
      (1004, 1000, 1000, 'DELIVERED', 11000),

      (1005, 1001, 1000, 'DELIVERED', 12000),
      (1006, 1001, 1000, 'DELIVERED', 15000),
      (1007, 1001, 1000, 'DELIVERED', 18800),
      (1008, 1001, 1000, 'DELIVERED', 19000),
      (1009, 1001, 1000, 'DELIVERED', 18000),

      (1010, 1002, 1000, 'DELIVERED', 12000),
      (1011, 1002, 1000, 'DELIVERED', 15000),
      (1012, 1002, 1000, 'DELIVERED', 13000),
      (1013, 1002, 1000, 'DELIVERED', 15000),
      (1014, 1002, 1000, 'DELIVERED', 16000),

      (1015, 1003, 1000, 'DELIVERED', 12000),
      (1016, 1003, 1000, 'DELIVERED', 13000),
      (1017, 1003, 1000, 'DELIVERED', 15000),
      (1018, 1003, 1000, 'DELIVERED', 18000),
      (1019, 1003, 1000, 'DELIVERED', 15000),

      (1020, 1004, 1000, 'DELIVERED', 15000),
      (1021, 1004, 1000, 'DELIVERED', 19000),
      (1022, 1004, 1000, 'DELIVERED', 15000),
      (1023, 1004, 1000, 'DELIVERED', 13000),
      (1024, 1004, 1000, 'DELIVERED', 15000),

      (1025, 1005, 1000, 'DELIVERED', 17000),
      (1026, 1005, 1000, 'DELIVERED', 12000),
      (1027, 1005, 1000, 'DELIVERED', 15100),
      (1028, 1005, 1000, 'DELIVERED', 15000),
      (1029, 1005, 1000, 'DELIVERED', 12000),

      (1030, 1006, 1000, 'DELIVERED', 15000),
      (1031, 1006, 1000, 'DELIVERED', 13000),
      (1032, 1006, 1000, 'DELIVERED', 19000),
      (1033, 1006, 1000, 'DELIVERED', 10000),
      (1034, 1006, 1000, 'DELIVERED', 15000),

      (1035, 1007, 1000, 'DELIVERED', 16000),
      (1036, 1007, 1000, 'DELIVERED', 15000),
      (1037, 1007, 1000, 'DELIVERED', 13000),
      (1038, 1007, 1000, 'DELIVERED', 15900),
      (1039, 1007, 1000, 'DELIVERED', 14000),

-- Ordenes en progreso
      (1040, 1000, 1000, 'PENDING', 14000),
      (1041, 1000, 1000, 'PREPARING', 12000),
      (1042, 1000, 1000, 'PREPARED', 10000),
      (1043, 1000, 1000, 'TRANSIT', 13000),
      (1044, 1000, 1000, 'TRANSIT', 15000),

-- Carritos de los clientes
      (1045, null, 1000, 'CART', null),
      (1046, null, 1001, 'CART', null),
      (1047, null, 1002, 'CART', null),
      (1048, null, 1003, 'CART', null),
      (1049, null, 1004, 'CART', null),
      (1050, null, 1005, 'CART', null),
      (1051, null, 1006, 'CART', null),
      (1052, null, 1007, 'CART', null),
      (1053, null, 1008, 'CART', null),
      (1054, null, 1009, 'CART', null);
